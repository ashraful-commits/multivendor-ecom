...
const Footer = () => {
  return (
    <ContainerBox>
      <section className="py-10 rounded-tl-2xl rounded-tr-2xl bg-gray-50 dark:bg-slate-900 sm:pt-16 lg:pt-24 w-full">
        <div className=" mx-auto container-fluid md:container lg:container">
          ...
          <p className="text-sm text-center text-gray-600">
            © Copyright 2021, All Rights Reserved by Multivendor
          </p>
        </div>
      </section>
    </ContainerBox>
