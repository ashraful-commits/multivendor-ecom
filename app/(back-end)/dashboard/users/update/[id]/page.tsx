...
import {useEditUserMutation,useGetSingleUserByIdQuery} from "@/lib/features/userapi"
...
const UpdateUser = () => {
  ...
  return (
    <div className="">
      <FromHeader title="Update User" href={"/dashboard/users"} />
      <div className="bg-slate-800 dark:bg-white border border-slate-800 dark:border-slate-200 rounded-md p-5">
        ...
        >
          ...
          <Select defaultValue={role} onValueChange={setUserRole} >
          ...
          <SubmitButton loading={isLoading} title="Update user" />
        </form>
      </div>
    </div>
  );
