...
const NewCategory = () => {
  ...
  const [editCategory, { isSuccess, isLoading }] = useEditCategoryMutation();
  ...
  }, [router, isSuccess, reset, data]);
  return (
    <div className="">
      <FromHeader title="Update Category" href={"/dashboard/categories"} />
      <FormContainer>
        <div className="bg-slate-800 dark:bg-white border border-slate-800 dark:border-slate-200 rounded-md p-5">
          ...
          >
            ...
            <ToggleInput
              ...
              register={register}
            />
            <SubmitButton loading={isLoading} title="Update Category" />
          </form>
        </div>
      </FormContainer>
    </div>
