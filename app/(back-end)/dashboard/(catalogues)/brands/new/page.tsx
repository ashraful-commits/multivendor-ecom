...
import { useAddNewBrandMutation } from "../../../../../../lib/features/brandapi";
...
const NewBrand = () => {
  const [addNewBrand, { isSuccess, isLoading }] = useAddNewBrandMutation();
        ...
        <div className="bg-slate-800 dark:bg-white border border-slate-800 dark:border-slate-200 rounded-md p-5">
          ...
          >
            ...
            <ToggleInput
              ...
              label="Publish Brand"
            />
            <SubmitButton loading={isLoading} title="Add brand" />
          </form>
        </div>
      </FormContainer>
    </div>
